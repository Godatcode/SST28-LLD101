 ...
 * Created only through the Builder (which does all validation).
 * Collections are defensively copied so outside code can't mess with internals.
 */
public final class IncidentTicket {
    ...
    private IncidentTicket(Builder b) {
        ...
        // defensive copy so the builder's list can't mutate us later
     ...
     * Useful for "updating" — just change what you need and build() again.
     */
